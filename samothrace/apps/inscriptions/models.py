...
class Inscription(models.Model):
    ...
    find_spot = models.ForeignKey(Site, on_delete=models.CASCADE)
    start_date = models.IntegerField(validators = [MaxValueValidator(9999)], blank=True, null=True)
    end_date = models.IntegerField(validators = [MaxValueValidator(9999)], blank=True, null=True)
    ...
    start_date_CE = models.IntegerField(validators = [MaxValueValidator(9999)], blank=True, null=True)
    end_date_CE = models.IntegerField(validators = [MaxValueValidator(9999)], blank=True, null=True)
    sites_mentioned = models.ManyToManyField(Site, related_name ='sites_mentioned', through='ReferenceSite', blank=True)
...
class Grant(models.Model):
    granting_name = models.ForeignKey(Site, related_name='granting', on_delete=models.CASCADE)
    receiving_name = models.ForeignKey(Site, related_name='receiving', on_delete=models.CASCADE)

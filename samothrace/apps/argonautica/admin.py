...
class StopsAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    pass     
    list_display = ['id','place_of_stop', 'type_of_stop','line_number','ritual','argonautica_edition']
...
class Places_ReferencedAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    pass     
    list_display = ['place_referenced','type_of_reference','line_number','ritual','argonautica_edition']

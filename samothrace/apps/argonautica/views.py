...
def Argo_Nodes1(request):
    ArgoNodeDataSource = Stops.objects.values('crew__origin__site_id', 'crew__origin__name', 'crew__origin__latitude', 'crew__origin__longitude').filter(type_of_stop='direct')
...
def Argo_Nodes2(request):
    ArgoNodeDataTarget = Stops.objects.values('place_of_stop__site_id', 'place_of_stop__name', 'place_of_stop__latitude', 'place_of_stop__longitude').filter(type_of_stop='direct')

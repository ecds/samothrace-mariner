...
#    GrantEdgesGrant = Site.objects.values('name', 'granting__id', 'granting_inscription', 'granting__receiving_name__name').filter(name__isnull=False).order_by('granting_inscription')
#    return render_to_csv_response(GrantEdgesGrant, field_header_map={'name':'source', 'granting_inscription':'inscription', 'granting__receiving_name__name':'target'})
# Getting there...
...
def Grant_Nodes1(request):
    ...
    return render_to_csv_response(GrantNodesGranting)

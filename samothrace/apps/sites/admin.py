...
class StopInline(LinkedInline):
    model = Stops
    extra = 0
    fields = ['line_number', 'type_of_stop','argonautica_edition']
    admin_model_parent = "argonautica"
    admin_model_path = "stops"
...
class Places_ReferencedInline(LinkedInline):
    ...
    extra = 0
    fields = ['line_number', 'type_of_reference','argonautica_edition']
    admin_model_parent = "argonautica"
...
class GrantInline(LinkedInline):
    model = Grant
    extra = 0
    fields = ['inscription', 'bibliographic']
    admin_model_parent = "inscriptions"
...
#      js = (settings.STATIC_URL + 'js/admin/collapseTabularInlines.js',)
    ...
    list_display = ['site_id', 'name', 'mod_name', 'latitude', 'longitude', 'pleiades_url', 'perseus_url']

...
def config_from_git():
    ...
    if samothrace.__version_info__[-1]:
...
Default: env.remote_path = /home/httpd/sites/samothrace
...
Example usage:
fab deploy:/home/samothrace/,dani -H servername
